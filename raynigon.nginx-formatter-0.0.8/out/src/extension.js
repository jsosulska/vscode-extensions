...
var nginxbeautifier = require("nginxbeautifier");
function formatText(text) {
    var lines = nginxbeautifier.clean_lines(text);
        ...
        provideDocumentFormattingEdits: function (document, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    text = formatText(document.getText());
                    return [2 /*return*/, [replaceTextInDocument(text, document)]];
                });
            });
        }
    });
